...
public class ListeJoueurs {
    ...
    private void setAllJoueurs() {
        ...
        for (int i = 0; i < this.listeId.size(); i++) {
            ...
            JoueurConcret j = new JoueurConcret(getName.getNom(), getName.getPrenom(), this.listeId.get(i), getName.getDate(), getName.getAdresse());
        }
...
//----------------Accesseurs et Mutateurs----------------------
    ...
    public Joueur recupJoueur(int id) {
        GetName getName = new GetName(id);
        return new JoueurConcret(getName.getNom(), getName.getPrenom(), id, getName.getDate(), getName.getAdresse());
    }
