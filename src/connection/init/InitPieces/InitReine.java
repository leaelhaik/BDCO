...
public class InitReine {
  ...
  // Finale
  static final String STMT1 = "Insert into Reine Values('1','E','1','E','1','blanc','1', 'finale')";
  static final String STMT2 = "Insert into Reine Values('2','E','8','E','8','noir','1', 'finale')";

  // Demies finale
  static final String STMT3 = "Insert into Reine Values('3','E','1','E','1','blanc','1', 'demiFinale')";
  static final String STMT4 = "Insert into Reine Values('4','E','8','E','8','noir','1', 'demiFinale')";
  static final String STMT5 = "Insert into Reine Values('5','E','1','E','1','blanc','2', 'demiFinale')";
  static final String STMT6 = "Insert into Reine Values('6','E','8','E','8','noir','2', 'demiFinale')";

  // Quarts de finale
  static final String STMT7 = "Insert into Reine Values('7','E','1','E','1','blanc','1', 'quartFinale')";
  static final String STMT8 = "Insert into Reine Values('8','E','8','E','8','noir','1', 'quartFinale')";
  static final String STMT9 = "Insert into Reine Values('9','E','1','E','1','blanc','2', 'quartFinale')";
  static final String STMT10 = "Insert into Reine Values('10','E','8','E','8','noir','2', 'quartFinale')";
  static final String STMT11 = "Insert into Reine Values('11','E','1','E','1','blanc','3', 'quartFinale')";
  static final String STMT12 = "Insert into Reine Values('12','E','8','E','8','noir','3', 'quartFinale')";
  static final String STMT13 = "Insert into Reine Values('13','E','1','E','1','blanc','4', 'quartFinale')";
  static final String STMT14 = "Insert into Reine Values('14','E','8','E','8','noir','4', 'quartFinale')";

  // Qualifications
  static final String STMTRB = "Insert into Reine Values('?','E','1','E','1','blanc','?', 'qualifications')";
